...
### 
# This code is implemeneted by zhuchen03 (Github) https://github.com/zhuchen03/gradinit/blob/master/models/resnet_cifar.py
# We modify Avgpool -> 1x1 conv in downsampling
###
    ...
    def _make_layer(self, block, planes, blocks, stride=1):
        ...
        if stride != 1:
            if self.use_bn:
                ...
                downsample = nn.Sequential(conv1x1(self.inplanes, planes, stride, bias= not self.use_bn))
